...
namespace GameProject.GameplaySystems
{
    public class BattleSystem
    {
        ...
        private void BattleStatus(Player player, Enemy enemy)
        {
            Console.Clear();
        ...
        private void ShowPlayerOptions(Player player)
        {
        ...
        private void PlayerInput(string input, Player player, Enemy enemy)
        {
            switch (input)
            {
                case "1":
        ...
        private void PlayerAttack(Player player, Enemy enemy, BodyTarget target)
        {
            ...
            else
            {
                ...
                if (hit)
                {
                    ...
                    Console.WriteLine($"Headshot! You deal {dmg} damage.");
                }
                else
                {
